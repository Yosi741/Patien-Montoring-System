package pages.medication.medication_catalog;
...
public class MedicationCatalogController {
    ...
    public static boolean showDialog(Window owner, User currentUser) {
        try {
            FXMLLoader loader = new FXMLLoader(AppNavigator.resolve("/pages/medication/medication_catalog/MedicationCatalogView.fxml"));

package pages.room_section.room_assignment;
...
public class RoomAssignmentController {
    ...
    private static boolean showDialog(Window owner, User currentUser, AssignmentAction action, long roomId, String patientId) {
        try {
            FXMLLoader loader = new FXMLLoader(AppNavigator.resolve("/pages/room_section/room_assignment/RoomAssignmentView.fxml"));

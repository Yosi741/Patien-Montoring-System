package ui.javafx.pages.patients.patient_form;
...
public class PatientFormController {
    ...
    private static boolean showDialog(Window owner, User currentUser, SqlitePatientDao.PatientDetail patient) {
        try {
            FXMLLoader loader = new FXMLLoader(AppNavigator.resolve("/ui/javafx/patients/patient_form/PatientFormView.fxml"));
